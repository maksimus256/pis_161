...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="https://nightbot.ru/pis_161/mvc/css/style.css" />
		<script src="https://nightbot.ru/pis_161/mvc/js/jquery-1.6.2.js" type="text/javascript"></script>
	...
	<body>
		<div id="wrapper">
			<div id="header">
				...
				<div id="menu">
					<ul>
						<li class="first active"><a href="https://nightbot.ru/pis_161/mvc/">Главная</a></li>
						<li><a href="https://nightbot.ru/pis_161/mvc/services">Услуги</a></li>
						<li><a href="https://nightbot.ru/pis_161/mvc/portfolio">Портфолио</a></li>
						<li class="last"><a href="https://nightbot.ru/pis_161/mvc/contacts">Контакты</a></li>
					</ul>
					<br class="clearfix" />
				</div>
			</div>
			<div id="page">
				<div id="sidebar">
					...
					<div class="side-box">
						<h3>Основное меню</h3>
						<ul class="list">
							<li class="first "><a href="https://nightbot.ru/pis_161/mvc/">Главная</a></li>
							<li><a href="https://nightbot.ru/pis_161/mvc/services">Услуги</a></li>
							<li><a href="https://nightbot.ru/pis_161/mvc/portfolio">Портфолио</a></li>
							<li class="last"><a href="https://nightbot.ru/pis_161/mvc/contacts">Контакты</a></li>
						</ul>
